...
class Gann():
    ...
    def configure_learning(self):
        # TODO: Be able to set the cost function.
        self.error = tf.reduce_mean(tf.square(self.target - self.output),name='MSE')
        self.predictor = self.output  # Simple prediction runs will request the value of output neurons
        # Defining the training operator
        # TODO:  Be able to choose optimizer: basic gradient descent, RMSprop, Adagrad and ADAM.
        optimizer = tf.train.GradientDescentOptimizer(self.learning_rate)
        self.trainer = optimizer.minimize(self.error,name='Backprop')

    # TODO: Steps total number of minibatches to be run through the system during training. ASK: Hva betyr dette?
    ...
    # TODO: do_mapping function that shows results of sending a small set of cases through the network with learning turned off.
    # TODO: map_layers, map_batch_size, map_dendrograms
    # def do_mapping()
...
class Gannmodule():
    ...
    def build(self):
        ...
        # TODO: Set upper and lower bound for weights
        # TODO: Dynamically calculating the weights (scale)
        ...
        #TODO: Hidden activation function.
...
# TODO: Input datafiles and functions needed to read that file. (A file reader function)
# TODO: Case fraction.
# TODO: Validation fraction.
# TODO: Validation and Test Fraction -> Caseman()
...
def autoex(epochs=300,nbits=4,lrate=0.03,showint=100,mbs=None,vfrac=0.1,tfrac=0.1,vint=100,sm=False,bestk=None):
    ...
    # TODO: display weights, display biases.
